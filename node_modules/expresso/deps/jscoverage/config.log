...
hostname = skplanet-ui-MacBook-Pro-32.local
uname -m = x86_64
uname -r = 13.0.0
uname -s = Darwin
...
Default processor set: 233 tasks, 1157 threads, 4 processors
Load average: 11.48, Mach factor: 0.47
/bin/machine           = unknown
/usr/bin/oslevel       = unknown
/bin/universe          = unknown

PATH: /usr/local/Cellar/node/0.10.22/lib/node_modules/npm/bin/node-gyp-bin
PATH: /development/work/git-flow-example/node_modules/expresso/node_modules/.bin
PATH: /development/work/git-flow-example/node_modules/.bin
PATH: /usr/local/Cellar/node/0.10.22/bin
PATH: /opt/local/bin
PATH: /opt/local/sbin
PATH: /usr/local/Cellar/node/0.10.22/bin/
PATH: /development/apache-maven-3.1.1/bin
PATH: /usr/bin
PATH: /bin
PATH: /usr/sbin
PATH: /sbin
...
configure:2271: result: i386-apple-darwin13.0.0
configure:2293: checking host system type
configure:2308: result: i386-apple-darwin13.0.0
...
configure:4200: result: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ld
configure:4209: checking if the linker (/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ld) is GNU ld
...
|   return 0;
| }
configure:4832: gcc -o conftest -g -O2   conftest.c  -liconv >&5
configure:4838: $? = 0
configure:4859: result: yes
configure:4862: checking for working iconv
configure:4948: gcc -o conftest -g -O2   conftest.c  -liconv >&5
configure:4951: $? = 0
...
configure:5752: gcc -c -g -O2  conftest.c >&5
configure:5758: $? = 0
...
configure:5931: gcc -E  conftest.c
configure:5937: $? = 0
...
configure:6175: gcc -c -g -O2  conftest.c >&5
configure:6181: $? = 0
...
configure:6508: gcc -o conftest -g -O2   conftest.c  >&5
...
on skplanet-ui-MacBook-Pro-32.local
...
ACLOCAL='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run aclocal-1.10'
AMDEPBACKSLASH='\'
AMDEP_FALSE='#'
AMDEP_TRUE=''
AMTAR='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run tar'
AUTOCONF='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run autoconf'
AUTOHEADER='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run autoheader'
AUTOMAKE='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run automake-1.10'
AWK='awk'
CC='gcc'
...
LTLIBICONV='-liconv'
LTLIBOBJS=''
MAKEINFO='${SHELL} /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/missing --run makeinfo'
OBJEXT='o'
PACKAGE='jscoverage'
PACKAGE_BUGREPORT=''
...
install_sh='$(SHELL) /development/work/git-flow-example/node_modules/expresso/deps/jscoverage/install-sh'
